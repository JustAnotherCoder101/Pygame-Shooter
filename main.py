...
class Player(pygame.sprite.Sprite):
    ...
    def tick(self, target_x, target_y):
        ...
        self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("Assets/Player.png"),
...
class Projectile(pygame.sprite.Sprite):
    def __init__(self, x, y, target_x, target_y):
        ...
        self.angle = math.atan2(target_y - self.rect.centery, target_x - self.rect.centerx)
        self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("Assets/Bullet.png"),
...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 1:  # Left mouse button
                new_projectile = Projectile(PLAYER.rect.centerx, PLAYER.rect.centery, *pygame.mouse.get_pos())
    ...
    if len(Zombies) < 5:  # Spawn up to 5 zombies
